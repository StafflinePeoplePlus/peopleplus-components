    ...
    <div class="flex items-center mx-auto">
        <p class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-400">
            ...
            <span>New brand identity has been launched for the
                <a href="https://peopleplus.co.uk" class="inline font-medium text-blue-600 underline dark:text-blue-500 underline-offset-2 decoration-600 dark:decoration-500 decoration-solid hover:no-underline">
                    PeoplePlus
                </a></span>
        </p>
    </div>
