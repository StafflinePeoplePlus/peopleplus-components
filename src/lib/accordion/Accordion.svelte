...
>
	<h2>
		<button
			type="button"
			class={twMerge(
				'relative flex w-full items-center justify-between p-5 text-left font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:outline-hidden focus:ring-2 focus:ring-red-400 dark:text-gray-100 dark:hover:bg-gray-600',
