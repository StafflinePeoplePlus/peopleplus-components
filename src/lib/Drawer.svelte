...
<div class="overflow-hidden top-0 right-0 bottom-0 z-40 {absolute ? 'absolute' : 'fixed'}">
	<div
		id="drawer-right-example"
		class="p-4 overflow-y-auto h-full transition-transform bg-white w-80 dark:bg-gray-800"
	...
	>
		...
		<p class="mb-6 text-sm text-gray-500 dark:text-gray-400">
			Supercharge your hiring by taking advantage of our <a
				...
				>limited-time sale</a
			>
			for Docs + Job Board. Unlimited access to over 190K top-ranked candidates and the #1 design job
			board.
		</p>
