...
<div class="bottom-0 right-0 top-0 z-40 overflow-hidden {absolute ? 'absolute' : 'fixed'}">
	<div
		id="drawer-right-example"
		class="h-full w-80 overflow-y-auto bg-white p-4 transition-transform dark:bg-gray-800"
